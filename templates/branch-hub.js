...
<div class="hub-head">
  <div>
    ...
    <p class="guide-intro">Every verified ${escapeHtml(branch.code)} subject currently live on JNTUStack, grouped by year and semester. This hub lists only pages that have been checked against a published source -- ${count} so far, with more added page by page, never dumped in unverified.</p>
  </div>

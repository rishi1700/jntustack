...
const ACTIONS = {
  reject: { status: 'rejected', audit: 'content_proposal.reject', requireNote: true },
  mark_needs_verification: { status: 'needs_verification', audit: 'content_proposal.mark_needs_verification', requireNote: true },
  request_changes: { status: 'changes_requested', audit: 'content_proposal.request_changes', requireNote: true },
  approve_for_draft: {
